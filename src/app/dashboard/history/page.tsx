...
const History = async () => {
  ...
  return (
    <div className='mx-5 py-2'>
      ...
      <div className='mt-5 py-6 p-4 bg-white rounded'>
        <Table>
          <TableCaption>List of your AI Output History</TableCaption>
          <TableHeader>
            <TableRow>
          ...
          <TableBody>{
            ...
            userHistory.map((history) => (
              <TableRow key={history.id}>
                ...
                <TableCell className='text-right'>{format(history.createdAt, 'dd/MM/yyyy')}</TableCell>
              </TableRow>
            ))
            : null
          }</TableBody>
